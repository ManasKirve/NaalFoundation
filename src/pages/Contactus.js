        ...
        <div className="container">
          <div className="row justify-content-center text-center">
            <div className="col-md-8">
              <h1>Contact Us</h1>
              <p className="lead">We'd love to hear from you. Reach out to us for any queries or support.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <form onSubmit={handleFormSubmit}>
        <div className="row align-items-stretch">
          <div className="col-md-6 mb-4">
            <input type="text" className="form-control h-100" placeholder="Your Full Name" required />
          </div>
          <div className="col-md-6 mb-4">
            <input type="email" className="form-control h-100" placeholder="Your Email Address" required />
          </div>
        </div>
        <div className="mb-4">
      ...
      <section className="map-section section-padding bg-light">
        <div className="container">
          <div className="text-center mb-5">
            ...
            <p className="section-subtitle">Visit our office to learn more about our work and how you can contribute.</p>
          </div>
